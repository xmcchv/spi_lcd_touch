...
// 在文件开头添加函数声明
static bool enable_calibration = false;  // 启用触摸校准
static void calibration_timer_callback(lv_timer_t *timer);

extern void example_lvgl_demo_ui(lv_disp_t *disp);
extern void get_button_info(lv_area_t *btn_area, int *width, int *height);
...
static lv_point_transform_t touch_calibration_matrix = {1, 1437, 1538, {39, 51}};
